---
layout: post
title:  "How Does Professional Life Science Data Base Works"
description:  "专业生物医药数据库产品主要是解决哪些问题，需要满足哪些要素，如何服务医疗+或者AIDD"
date:  2022-10-22 06:15:11 +0800
author: Ye Zhongkai
categories: Original Article
tags: Life Science database 
---

## 前言
因近期正好需要针对生物医药数据库在 AIDD 领域所处的情况做一个分析，所以趁此机会大概总结了一下 AIDD 的现状，以及专业数据库在医疗+ 和 AIDD 领域产业链所处的位置。以及针对专业数据库所解决的问题进行一个概览性的总结。
